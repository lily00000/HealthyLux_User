...
class TrainingChest extends StatefulWidget {
  @override
  _TrainingChestState createState() => _TrainingChestState();
}

class _TrainingChestState extends State<TrainingChest> {
